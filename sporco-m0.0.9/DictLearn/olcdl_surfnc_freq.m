function [D, optinf] = olcdl_surfnc_freq(D0, S, lambda, opt)

% olcdl_surfnc_freq -- Online Convolutional Dictionary Learning
%         (surrogate function approach, frequency domain computation)
%
...
%
% Usage:
%       [D, optinf] = olcdl_surfnc_freq(D0, S, lambda, opt);
%
% Input:
