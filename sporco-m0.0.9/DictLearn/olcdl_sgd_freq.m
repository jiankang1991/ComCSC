function [D, optinf] = olcdl_sgd_freq(D0, S, lambda, opt)

% olcdl_sgd_freq -- Online Convolutional Dictionary Learning
%         (SGD approach, frequency domain computation)
%
...
%
% Usage:
%       [D, optinf] = olcdl_sgd_freq(D0, S, lambda, opt);
%
% Input:
...
while k <= opt.MaxMainIter,
  ...
  Gf = Gf - eta * gra;
  G = Pcn(ifft2(Gf));  % projection in spacial domain
  Gf = fft2(G);
