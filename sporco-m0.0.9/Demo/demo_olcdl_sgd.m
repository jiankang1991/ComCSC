% Script demonstrating usage of the olcdl_sgd_freq and olcdl_sgd_sprs functions.
%
...
[D, optinf] = olcdl_sgd_freq(D0, Sh, lambda, opt);
% To use sparse matrix solution method, comment line above and
% uncomment line below
% [D, optinf] = olcdl_sgd_sprs(D0, Sh, lambda, opt);
