% Script demonstrating usage of the olcdl_sgd_freq_msk and olcdl_sgd_sprs_msk
% functions.
%
...
W = ~wn;
% [D, optinf] = olcdl_sgd_freq_msk(D0, Sh, lambda, W, opt);
% To use sparse matrix solution method, comment line above and
% uncomment line below
[D, optinf] = olcdl_sgd_sprs_msk(D0, Sh, lambda, W, opt);
